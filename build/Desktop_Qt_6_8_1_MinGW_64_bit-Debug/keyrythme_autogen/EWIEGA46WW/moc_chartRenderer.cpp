...
namespace {
struct qt_meta_tag_ZN13ChartRendererE_t {};
} // unnamed namespace


#ifdef QT_MOC_HAS_STRINGDATA
static constexpr auto qt_meta_stringdata_ZN13ChartRendererE = QtMocHelpers::stringData(
    "ChartRenderer",
    "updateFrame",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN13ChartRendererE[] = {
...
Q_CONSTINIT const QMetaObject ChartRenderer::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN13ChartRendererE.offsetsAndSizes,
    qt_meta_data_ZN13ChartRendererE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN13ChartRendererE_t,
        // Q_OBJECT / Q_GADGET
...
void *ChartRenderer::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN13ChartRendererE.stringdata0))
